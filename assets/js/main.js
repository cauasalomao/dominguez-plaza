      ...
      <div class="wl-box" role="document">
        ...
        <form class="wl-form" id="waLeadForm" novalidate>
          ...
          <div class="wl-fg">
            ...
            <input id="wl-telefone" name="telefone" type="tel" placeholder="(22) 99999-9999" required autocomplete="tel">
          </div>
...
// ── WIDGET DE RESERVAS NA HERO (desktop) ──
